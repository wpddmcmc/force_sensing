%clear all
cam1 = webcam(2);  %%% You have to see 25 elements by cam1, if you cannot, please change number 3 to 1 or 2 
cam2 = webcam(1);  %%% You have to see 10 elements by cam2, if you cannot, please change number 1 to 2 or 3 
...
sqrt(Force(i,1)^2+Force(i,2)^2+Force(i,3)^2)
